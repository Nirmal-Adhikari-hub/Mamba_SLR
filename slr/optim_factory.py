...
def get_num_layer_for_model(var_name, num_max_layer):
    if var_name in ("cls_token"):
        return 0
    elif var_name.startswith("patch_embed"):
        return 0
    elif 'spatial' in var_name or 'mlp' in var_name:
...
class LayerDecayValueAssigner(object):
    ...
    def get_layer_id(self, var_name):
        return get_num_layer_for_model(var_name, len(self.values))
